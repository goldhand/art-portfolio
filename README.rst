...
.. code-block:: bash
    ...
    heroku run python art-portfolio/manage.py syncdb --noinput --settings=config.settings
    heroku run python art-portfolio/manage.py migrate --settings=config.settings
    heroku run python art-portfolio/manage.py collectstatic --settings=config.settings
